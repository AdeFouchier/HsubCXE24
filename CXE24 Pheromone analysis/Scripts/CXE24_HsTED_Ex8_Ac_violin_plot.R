...
CXE24_CRISPR_pheromone<- subset(CXE24_pheromone, Experience=="HsTED_Ex8")
...
x_palette <- c("#468499", # 1st x = ss  
               "#87B6D1", # 2nd x = he
               "#D8E6F3") # 3rd x = mut

#### Plotting Violin without points ####

Plot_CXE24_HSTED_Ex8_Ac_level <- ggplot(data = plot_data,
                           aes(x = Genotype,
                               y = Total_Ac))+
...
Plot_CXE24_HSTED_Ex8_Ac_level
#Total amount of Ac (ng)#
Plot_CXE24_HSTED_Ex8_Ac_am <- ggplot(data = plot_data,
                                      aes(x = Genotype,
                                          y = Total_Ac_am))+
  geom_violin(aes (color=x),
              width = 1,
...
Plot_CXE24_HSTED_Ex8_Ac_am
#Total amount of Ac log contrasted by Z9-14Ald#
Plot_CXE24_HSTED_Ex8_Ac_log_contrasted <- ggplot(data = plot_data,
                                     aes(x = Genotype,
...
Plot_CXE24_HSTED_Ex8_Ac_log_contrasted
#Total amount of Ac log contrasted by 14Ald#
Plot_CXE24_HSTED_Ex8_Ac_log_contrasted_14Ald <- ggplot(data = plot_data,
                                                 aes(x = Genotype,
                                                     y = `Tot_ac/14Ald_log`))+
  geom_violin(aes (color=x),
              width = 1,
...
Plot_CXE24_HSTED_Ex8_Ac_log_contrasted_14Ald
#### Cleaning ####
rm(plot_data,
   #plot_data_info,
   x_palette)
