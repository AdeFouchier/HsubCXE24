...
CXE24_CRISPR_pheromone<- subset(CXE24_pheromone, Experience=="CRISPR_Ex2")
...
x_palette <- c("#FFA500", # 1st x = wt
               "#FFD556", # 2nd x = he
               "#FFF7C7") # 3rd x = mut

#### Plotting Violin plot ####
#relative % of Ac#
Plot_CXE24_CRISPR_Ex2_Ac_level <- ggplot(data = plot_data,
                           aes(x = Genotype,
                               y = Total_Ac))+
...
Plot_CXE24_CRISPR_Ex2_Ac_level

#Total amoun of Ac (ng)#
Plot_CXE24_CRISPR_Ex2_Ac_am <- ggplot(data = plot_data,
                                         aes(x = Genotype,
                                             y = Total_Ac_am))+
  geom_violin(aes (color=x),
              width = 1,
...
Plot_CXE24_CRISPR_Ex2_Ac_am
#Total amount of Ac log contrasted by Z9-14Ald#
Plot_CXE24_HSTED_Ex2_Ac_log_contrasted <- ggplot(data = plot_data,
                                                 aes(x = Genotype,
...
Plot_CXE24_HSTED_Ex2_Ac_log_contrasted

#Total amount of Ac log contrasted by 14Ald#
Plot_CXE24_HSTED_Ex2_Ac_log_contrasted_14Ald <- ggplot(data = plot_data,
                                                 aes(x = Genotype,
                                                     y = `Tot_ac/14Ald_log`))+
  geom_violin(aes (color=x),
              width = 1,
...
Plot_CXE24_HSTED_Ex2_Ac_log_contrasted_14Ald
#### Cleaning ####
rm(plot_data,
  #plot_data_info,
   x_palette)
